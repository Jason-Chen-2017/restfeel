 ...
 */
package com.restfeel.sample.data;
...
import com.restfeel.constant.PermissionType;
import com.restfeel.constant.RoleType;
import com.restfeel.controller.rest.ConfigController;
import com.restfeel.controller.rest.ConversationController;
import com.restfeel.controller.rest.NodeController;
import com.restfeel.controller.rest.PermissionController;
import com.restfeel.controller.rest.ProjectController;
import com.restfeel.controller.rest.RoleController;
import com.restfeel.controller.rest.TagController;
import com.restfeel.controller.rest.UserController;
import com.restfeel.controller.rest.WorkspaceController;
import com.restfeel.dao.HttpRequestHeaderRepository;
import com.restfeel.dao.UserRepository;
import com.restfeel.dto.BasicAuthDTO;
import com.restfeel.dto.ConfigDTO;
import com.restfeel.dto.ConversationDTO;
import com.restfeel.dto.NodeDTO;
import com.restfeel.dto.PasswordDTO;
import com.restfeel.dto.PermissionDTO;
import com.restfeel.dto.ProjectDTO;
import com.restfeel.dto.RfRequestDTO;
import com.restfeel.dto.RoleDTO;
import com.restfeel.dto.TagDTO;
import com.restfeel.dto.UrlParamDTO;
import com.restfeel.dto.WorkspaceDTO;
import com.restfeel.entity.Config;
import com.restfeel.entity.HttpRequestHeader;
...
public class SampleDataGenerator {
    ...
    private void createSuperUser() {
        User user = userRepository.findByEmail("universsky@163.com");
        ...
        user2.setName("Root");
        user2.setEmail("root@example.com");
        user2.setPassword("root");
        userController.create(user2);

        PasswordDTO user3 = new PasswordDTO();
        user3.setName("Jason");
        user3.setEmail("universsky@163.com");
    ...
    private void loadProjectData() {
        ...
        createSocialSample(projGoogle, "https://www.googleapis.com/plus/v1/people/me", "GET", "Google Plus",
            "Get Access Token from Auth and run this request. Enable Google Plus API in your account https://console"
        ...
        createSocialSample(projFacebook, "https://graph.facebook.com/me", "GET", "Graph API",
            "Get Access Token from Auth and run this request. Do needful settings for your app in https://developers"
				+ ".facebook.com",
            null, null);
    ...
    private void loadNodeData() {
        System.out.println("HOST URI:" + hostUri);
        ...
        childNode.setDescription(
            "A workspace is a collection of projects. This API returns list of available workspaces.");
        ...
        secondNode.setDescription(
            "A workspace is a collection of projects. This API is used to create a new workspace.");
        ...
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/ip", "GET", "httpbin ip", "Returns Origin IP.", null,
            null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/user-agent", "GET", "httpbin User Agent",
            "Returns user-agent.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/headers", "GET", "httpbin Headers",
            "Returns header dict.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/get", "GET", "httpbin Get", "Returns GET data.", null,
            null, null);
        ...
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/post", "POST", "Post", "POST method testing.",
            urlParams, jsonObjectSample, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/encoding/utf8", "GET", "UTF-8",
            "Returns page containing UTF-8 data.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/delete", "DELETE", "Delete", "Returns DELETE data.",
            null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/gzip", "GET", "Gzip", "Returns gzip-encoded data.",
            null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/deflate", "GET", "Deflate",
            "Returns deflate-encoded data.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/status/418", "GET", "Status code",
            "Returns given HTTP Status code.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT,
            "http://httpbin.org/response-headers?Content-Type=text/plain;charset=UTF-8&Server=httpbin", "GET",
            "httpbin Content type", "Returns given response headers.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/redirect/6", "GET", "httpbin redirect", "Redirects.",
            null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/redirect-to/url=http://example.com/", "GET",
            "Redirect-to", "Redirects to the url.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/relative-redirect/6", "GET", "Relative redirect",
            "Relative Redirect.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/absolute-redirect/6", "GET", "Absolute redirect",
            "Absolute Redirect.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/cookies", "GET", "Cookies", "Returns cookie data.",
            null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/cookies/set?k2=v2&k1=v1", "GET", "Simple Cookies",
            "Sets one or more simple cookies.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/cookies/delete?k2=&k1=", "GET", "Delete Cookies",
            "Deletes one or more simple cookies.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/basic-auth/user/passwd", "GET", "Basic Auth",
            "Challenges HTTPBasic Auth.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/hidden-basic-auth/user/passwd", "GET",
            "Hidden Basic Auth", "404'd BasicAuth.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/digest-basic-auth/auth/user/passwd", "GET",
            "Digest Auth", "Challenges HTTP Digest Auth.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/stream/20", "GET", "Digest Auth",
            "Streams n–100 lines.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/delay/3", "GET", "Delay",
            "Delays responding for n–10 seconds.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/drip?duration=5&numbytes=5&code=200", "GET", "Drip",
            "Drips data over a duration after an optional initial delay, then (optionally) returns with the given "
				+ "status code.",
            null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/range/1024", "GET", "Range",
            "Streams n bytes, and allows specifying a Range header to select a subset of the data. Accepts a "
				+ "chunk_size and request duration parameter.",
            null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/html", "GET", "HTML", "Renders an HTML Page.", null,
            null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/robots.txt", "GET", "Robots.txt",
            "Returns some robots.txt rules.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/deny", "GET", "Deny", "Denied by robots.txt file.",
            null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/cache", "GET", "Cache",
            "Returns 200 unless an If-Modified-Since or If-None-Match header is provided, when it returns a 304.", null,
            null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/cache/60", "GET", "Cache-Control",
            "Sets a Cache-Control header for n seconds.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/bytes/1024", "GET", "Bytes",
            "Generates n random bytes of binary data, accepts optional seed integer parameter.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/stream-bytes/1024", "GET", "Stream-bytes",
            "Streams n random bytes of binary data, accepts optional seed and chunk_size integer parameters.", null,
            null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/links/10", "GET", "Bytes",
            "Returns page containing n HTML links.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/image", "GET", "Image",
            "Returns page containing an image.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/image/png", "GET", "Image PNG",
            "Returns page containing PNG image.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/image/jpeg", "GET", "Image JPEG",
            "Returns page containing JPEG image.", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/image/webp", "GET", "Image",
            "Returns page containing WEBP image.", null, null, null);
        //CheckPost form returns the form but doesn't return response on submit.
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/forms/post", "GET", "Post form",
            "HTML form that submits to /post", null, null, null);
        createSampleRequest(HTTPBIN_PROJECT, "http://httpbin.org/xml", "GET", "XML", "Returns some XML", null, null,
            null);

        createSampleRequest("gitProject", "https://api.github.com/users/anujak", "GET", "Git Profile",
            "Get Git profile by username", null, null, null);
        BasicAuthDTO basicAuth = new BasicAuthDTO();
        basicAuth.setUsername("username");
        basicAuth.setPassword("password");
        createSampleRequest("gitProject", "https://api.github.com/user", "GET", "Basic Auth Logged in User Profile",
            "Get Git profile of logged in user by basic authentication", null, null, basicAuth);
    }

    private void createSampleRequest(String projectName, String apiUrl, String methodType, String name,
                                     String description, List<UrlParamDTO> urlParams, JSONObject jsonObject,
                                     BasicAuthDTO basicAuth) {
        String projId = null;
    ...
    private void createSocialSample(Project project, String apiUrl, String methodType, String name, String description,
                                    List<UrlParamDTO> urlParams, JSONObject jsonObject) {
    ...
    private void loadHttpRequestHeaders() {
        String[] headersArr = {"Accept", "Accept-Charset", "Accept-Encoding", "Accept-Language", "Accept-Datetime",
            "Authorization",
